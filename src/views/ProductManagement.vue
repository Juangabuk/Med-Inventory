    ...
    <div>
        ...
        <div style="margin-left: 2%">
            ...
            <div class="search-bar mt-3 flex items-center w-1/2">
                    ...
                    <div v-if="dropdownOpenSort"
                        ...
                        <ul>
                            ...
                            <li @click="sortItems('Jumlah Desc')" class="p-2 hover:bg-gray-200 cursor-pointer">Stock
                                terbanyak</li>
                            <li @click="sortItems('Jumlah Asc')" class="p-2 hover:bg-gray-200 cursor-pointer">Stock
                                terendah</li>
                ...
                <div class="relative ml-2">
                    <button @click="toggleDropdownFilter"
                        class="filter-button p-2 border rounded bg-blue-500 text-white">
                        Filter ☰
                    </button>
